...
const Guide: React.FC = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-20 py-8 md:py-12 bg-gray-100 gap-8 md:gap-16 justify-center items-center">
      {/* Left Section */}
          ...
          {rooms.map((room) => (
            <div key={room.img} className="flex flex-col items-center">
              <Image
                ...
                alt={room.text}
                width={112} // Adjust sizes as per your design
                height={136}
